	...
	<div class="login_page">
		...
		<div class="user_profile_content">
			<div class="text">
				...
				<input type="text" placeholder="<?php echo $data['login']?>" name="login" disabled>
			</div>
			<div class="text2">
				<p class="name">ФИО:</p>
				<input type="text" placeholder="<?php echo $data['name']?>" name="name" disabled>
			</div>
			<a href=<?php echo "/admin/edit_user/" . $data['id']; ?>>Изменить профиль</a>
		</div>
	</div>
</form>